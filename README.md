...
| -------- | --------------------- | ------------------------------------------------------------------------------- |
| Linux    | amd64                 | [tag-linux-amd64](https://tag-releases.t3.storage.dev/v1.9.3/tag-linux-amd64)   |
| Linux    | arm64                 | [tag-linux-arm64](https://tag-releases.t3.storage.dev/v1.9.3/tag-linux-arm64)   |
| macOS    | arm64 (Apple Silicon) | [tag-darwin-arm64](https://tag-releases.t3.storage.dev/v1.9.3/tag-darwin-arm64) |

To download a specific version, replace `v1.9.3` with the desired version tag:
